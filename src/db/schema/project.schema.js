import { pgTable, uuid, text, timestamp, boolean, numeric, integer, json, pgEnum } from 'drizzle-orm/pg-core';
import { users } from './user.schema.js';

export const projectFeeTypeEnum = pgEnum('project_fee_type', ['PERCENTAGE', 'FIXED']);
export const projectStatusEnum  = pgEnum('project_status', ['DRAFT', 'PUBLISHED', 'ARCHIVED', 'CLOSED', 'UNPUBLISHED']);
